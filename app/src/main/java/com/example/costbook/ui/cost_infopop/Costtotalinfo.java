...
public class Costtotalinfo extends Activity  {
    private Button close,totalcost;
    private int gardenId,productId;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.costtotal_info);
        close = findViewById(R.id.PopupInfoClose);
        cost=findViewById(R.id.costtotal);
        ButterKnife.bind(this);
        gardenId=getIntent().getIntExtra("gardenID",0);
        productId=getIntent().getIntExtra("productID",0);


        getTotalcostmethod(productId,gardenId);
    ...
    private void getTotalcostmethod(int productID,int gardenID) {
        ...
        Call<Object> call = apiService.CategoryCost(productID,gardenID);
        call.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                if( a==null){
                    Toast.makeText(getApplicationContext(), "Bu tarla ve ürüne ait masraf bilgisi bulunamadı.", Toast.LENGTH_LONG).show();
                    loadingProgress.dismissProgress();
                    finish();
                }
            }
