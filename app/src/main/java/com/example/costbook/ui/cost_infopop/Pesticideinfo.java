...
public class Pesticideinfo extends Activity {
    ...
    private void getPeticidecostmethod(int productID, int gardenID) {
        ...
        Call<Object> call = apiService.getPresticideCost(productID,gardenID);
        call.enqueue(new Callback<Object>() {
            ...
            public void onFailure(Call<Object> call, Throwable t) {
                Toast.makeText(getApplicationContext(), "Veriler yüklenirken hata oluştu.", Toast.LENGTH_LONG).show();
