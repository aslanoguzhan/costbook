...
public class OrganicFertilizersinfo extends Activity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.organicfertilizersinfo);
        close = findViewById(R.id.PopupInfoClose);
        cost=findViewById(R.id.costorganicfertilizers);
        ButterKnife.bind(this);
        gardenıd=getIntent().getIntExtra("gardenID",0);
        productıd=getIntent().getIntExtra("productID",0);

        getOrganicfeertilizersmethod(productıd,gardenıd);
    ...
    private void getOrganicfeertilizersmethod(int productID, int gardenID) {
        ...
        Call<Object> call = apiService.getOrganicfertilizersCost(productID,gardenID);
