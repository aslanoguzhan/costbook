...
public class SeedCostinfo extends Activity {
    ...
    private void getSeedcostmethod(int productID, int gardenID) {
        ...
        Call<Object> call = apiService.getSeedCost(productID,gardenID);
