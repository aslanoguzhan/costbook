...
public class FuelCostinfo extends Activity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fuelcostinfo);
        close = findViewById(R.id.PopupInfoClose);
        cost=findViewById(R.id.costfuel);
    ...
    private void windowSize() {
        ConstraintLayout constraintLayout = findViewById(R.id.fuelcostinfo);
    ...
    private void getFuelCostMethod(int productID, int gardenID) {
        ...
        Call<Object> call = apiService.getFuelCost(productID,gardenID);
