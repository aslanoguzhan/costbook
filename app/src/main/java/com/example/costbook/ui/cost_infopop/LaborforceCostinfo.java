...
public class LaborforceCostinfo extends  Activity  {
    ...
    private void getLaborforcecostmethod(int productID, int gardenID) {
        ...
        Call<Object> call = apiService.getLaborforceCost(productID,gardenID);
